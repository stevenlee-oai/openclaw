...
export const de: TranslationMap = {
  ...
  newSession: {
    ...
    draft: "Entwurf",
    draftDescription: "Diesen Thread für dich behalten, bis du ihn veröffentlichst",
  ...
  subtitles: {
    ...
    dashboards: "Threads, die auf ihrer Dashboard-Ansicht geöffnet werden.",
  ...
  memoryPage: {
    ...
    engine: {
      title: "Engine",
      description:
        "Genau ein Memory-Plugin belegt den Memory-Slot. Durch Auswahl einer Engine wird diese aktiviert und die anderen deaktiviert.",
      rowTitle: "Memory-Engine",
      off: "Aus",
      autoHint:
        "In der Konfiguration ist keine Engine fixiert, daher fällt der Slot auf seinen Standardbesitzer zurück.",
      explicitHint: "Diese Engine ist in der Konfiguration unter plugins.slots.memory fixiert.",
      offHint:
        "Memory ist in der Konfiguration ausgeschaltet: plugins.slots.memory ist auf none gesetzt.",
      ...
      disabledHint:
        "Der Memory-Slot verweist auf dieses Plugin, aber das Plugin selbst ist deaktiviert, sodass der Speicher nicht ausgeführt wird.",
      enable: "Aktivieren Sie",
    },
    backend: {
      title: "Backend",
    ...
    addons: {
      title: "Add-ons",
      description:
        "Diese Plugins ergänzen die Engine, anstatt um den Slot zu konkurrieren, sodass jede Kombination gleichzeitig laufen kann.",
      activeMemory: {
    ...
    import: {
      title: "Importieren",
      description:
        "Bestehenden Speicher von anderen Assistenten in einen Agenten-Workspace übernehmen.",
    ...
    dreaming: {
      ...
      frequency: {
        ...
        help: "Cron-Intervall für den vollständigen Dreaming-Durchlauf (light, REM, dann deep). Leer lassen für den Plugin-Standard.",
        placeholder: "0 3 * * *",
      },
      timezone: {
        label: "Zeitzone",
      ...
      model: {
        ...
        help: "Provider-/Modell-Override für die Traumtagebuch-Narration. Erfordert, dass Subagent-Modell-Overrides erlaubt sind.",
      ...
      storage: {
        title: "Speicher",
        description: "Wohin geförderte Erinnerungen und Dreaming-Berichte geschrieben werden.",
        modeLabel: "Speichermodus",
        modeHelp:
          "Inline schreibt in die Memory-Datei; Separate verwendet eine dedizierte Berichtsdatei.",
        modes: {
          inline: "Inline",
          separate: "Separat",
          both: "Beides",
        ...
        separateReportsHelp: "Dreaming-Berichte aus der Haupt-Memory-Datei heraushalten.",
      },
      phases: {
        light: {
          title: "Light-Phase",
          description:
            "Kostengünstiger Durchlauf der jüngsten Aktivitäten, der Wiederholungskandidaten vorbereitet.",
        },
        deep: {
          title: "Tiefe Phase",
          description:
            "Bewerteter Beförderungsdurchlauf, der Kurzzeiteinträge in den Speicher überführt.",
        },
        rem: {
          title: "REM-Phase",
          description:
      ...
      phaseFields: {
        ...
        limit: "Limit",
        limitHelp: "Maximale Anzahl der Einträge, die diese Phase pro Durchlauf verarbeitet.",
        ...
        minUniqueQueriesHelp: "Wie viele verschiedene Abfragen den Eintrag angezeigt haben müssen.",
        ...
        maxAgeDaysHelp: "Kurzzeit-Einträge, die älter sind, ignorieren.",
        maxPromotedSnippetTokens: "Max. Token für hochgestufte Snippets",
      ...
      agentScope: {
        title: "Agenten-Ansicht",
        description:
          "Die obigen Einstellungen sind global. Das Traumtagebuch, die Kurzzeit-Zählungen und die Wartungsaktionen unten gehören zu einem Agenten.",
        rowTitle: "Agent",
      },
      unsupported: {
        ...
        description:
          "Das Plugin {plugin} besitzt den Speicherplatz und sein Konfigurationsschema hat keinen Traum-Abschnitt, daher können diese Einstellungen nicht gespeichert werden. Wechseln Sie die Engine im Tab „Übersicht“, um sie zu bearbeiten.",
      },
    },
  },
  sessionsPage: {
  ...
  labsPage: {
    ...
    toolSearch: {
      title: "Tool-Suche",
      description:
        "Halten Sie ein begrenztes Tool-Verzeichnis sichtbar und lagern Sie den Rest hinter die Suche aus, damit große MCP- und Plugin-Kataloge den Prompt nicht mehr überfüllen.",
    },
    localModelLean: {
    ...
    auditMessages: {
      ...
      description:
        "Inhaltsfreie Metadaten für direkte Konversationen im Audit-Ledger aufzeichnen. Nachrichteninhalte werden niemals gespeichert.",
    },
  },
  aboutPage: {
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      ...
      enableDetail:
        "Der nächtliche Dreaming-Durchlauf wird in jedem konfigurierten Agenten-Workspace ausgeführt und überführt kurzfristige Erinnerungen in das Langzeitgedächtnis. Dies wird sofort wirksam.",
  ...
  chat: {
    ...
    sessionRoute: {
      ...
      additionalMatches: "Es bleiben Suchergebnisse übrig. Verwende ein längeres ID-Präfix.",
    },
    sessionSharing: {
