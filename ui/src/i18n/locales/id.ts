...
export const id: TranslationMap = {
  ...
  newSession: {
    ...
    draft: "Draf",
    draftDescription: "Simpan thread ini untuk diri sendiri sampai Anda mempublikasikannya",
  ...
  dashboardsPage: {
    ...
    emptyDescription: "Buka thread dan beralih ke face Dashboard untuk menambahkannya di sini.",
  ...
  subtitles: {
    ...
    dashboards: "Thread yang terbuka pada face dashboard-nya.",
  ...
  memoryPage: {
    ...
    engine: {
      title: "Mesin",
      description:
        "Tepat satu plugin memori memiliki slot memori. Memilih mesin akan mengaktifkannya dan menonaktifkan yang lain.",
      rowTitle: "Mesin memori",
      off: "Nonaktif",
      autoHint:
        "Tidak ada mesin yang disematkan dalam config, jadi slot kembali ke pemilik default-nya.",
      explicitHint: "Mesin ini disematkan dalam config di bawah plugins.slots.memory.",
      offHint: "Memori dimatikan dalam config: plugins.slots.memory disetel ke none.",
      ...
      disabledHint:
        "Slot memori menunjuk ke plugin ini, tetapi plugin itu sendiri dinonaktifkan, sehingga memori tidak berjalan.",
      enable: "Aktifkan",
    },
    backend: {
      title: "Backend",
    ...
    addons: {
      title: "Add-on",
      description:
        "Plugin ini berlapis di atas mesin alih-alih bersaing untuk slot, sehingga kombinasi apa pun dapat berjalan sekaligus.",
      activeMemory: {
        title: "Memori aktif",
      },
      memoryWiki: {
    ...
    import: {
      title: "Impor",
      description: "Bawa memori yang ada dari asisten lain ke ruang kerja agen.",
    ...
    dreaming: {
      intro:
        "Dreaming berjalan sebagai satu cron job terkelola di seluruh ruang kerja agen, sehingga pengaturan ini bersifat global. Pengaturan ini dimiliki oleh plugin {plugin}.",
      schedule: {
        title: "Jadwal",
        description: "Kapan sapuan penuh berjalan dan model mana yang menarasikannya.",
      },
      frequency: {
        label: "Frekuensi dreaming",
        help: "Irama cron untuk sapuan dreaming penuh (light, REM, lalu deep). Biarkan kosong untuk default plugin.",
        placeholder: "0 3 * * *",
      },
      timezone: {
        label: "Zona waktu",
      ...
      model: {
        ...
        help: "Penggantian provider/model untuk narasi diary dreaming. Membutuhkan penggantian model subagent yang diizinkan.",
      ...
      storage: {
        ...
        separateReportsHelp: "Jaga laporan dreaming tetap di luar file memori utama.",
      },
      phases: {
        light: {
          title: "Fase light",
          description: "Proses aktivitas terkini yang hemat untuk menyiapkan kandidat replay.",
        },
        deep: {
          title: "Fase deep",
          description: "Proses promosi berskor yang menaikkan entri jangka pendek ke memori.",
        },
        rem: {
          title: "Fase REM",
          description: "Proses pola yang mencari tema berulang di seluruh jendela lookback.",
        },
      },
      phaseFields: {
        enabled: "Aktif",
        ...
        lookbackDaysHelp:
          "Seberapa jauh ke belakang fase ini membaca. Kosongkan untuk default plugin.",
        limit: "Batas",
        limitHelp: "Entri maksimum yang diproses fase ini per pengoperasian.",
        dedupeSimilarity: "Kemiripan dedupe",
        dedupeSimilarityHelp: "Kemiripan di atas mana dua kandidat dianggap duplikat.",
        minScore: "Skor minimum",
        minScoreHelp: "Skor promosi yang harus dicapai sebuah entri.",
        minRecallCount: "Recall minimum",
        minRecallCountHelp:
          "Seberapa sering sebuah entri harus di-recall sebelum dapat dipromosikan.",
        minUniqueQueries: "Kueri unik minimum",
        minUniqueQueriesHelp: "Berapa banyak kueri berbeda yang harus memunculkan entri.",
        recencyHalfLifeDays: "Waktu paruh recency (hari)",
        recencyHalfLifeDaysHelp: "Seberapa cepat sinyal recall yang lebih lama kehilangan bobot.",
        ...
        maxPromotedSnippetTokensHelp:
          "Anggaran token untuk setiap snippet terpromosi. Provenans tetap terlampir.",
      ...
      agentScope: {
        title: "Tampilan agen",
        description:
          "Pengaturan di atas bersifat global. Diari mimpi, jumlah jangka pendek, dan tindakan pemeliharaan di bawah ini milik satu agen.",
        rowTitle: "Agen",
      },
      unsupported: {
        ...
        description:
          "Plugin {plugin} memiliki slot memori dan skema konfigurasinya tidak memiliki bagian dreaming, sehingga pengaturan ini tidak dapat disimpan. Alihkan engine di tab Overview untuk mengeditnya.",
      },
    },
  },
  sessionsPage: {
  ...
  labsPage: {
    ...
    toolSearch: {
      ...
      description:
        "Pertahankan direktori alat yang terbatas tetap terlihat dan tunda sisanya di balik pencarian, sehingga katalog MCP dan plugin yang besar tidak lagi memenuhi prompt.",
    },
    localModelLean: {
      title: "Alat ringkas untuk model lokal",
      description:
        "Hilangkan alat default yang berat yang ditangani buruk oleh model lokal yang lebih kecil, menyisakan set yang lebih pendek yang dapat mereka gunakan dengan andal.",
    },
    auditMessages: {
      title: "Metadata audit pesan",
      description:
        "Rekam metadata tanpa konten untuk percakapan langsung dalam ledger audit. Konten pesan tidak pernah disimpan.",
    },
  },
  aboutPage: {
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      subtitle: "Dreaming adalah pengaturan global; tidak dicakupkan ke agen ini.",
      enableTitle: "Aktifkan Dreaming untuk Semua Agen",
      enableDetail:
        "Sapuan dreaming malam hari akan berjalan di setiap ruang kerja agen yang dikonfigurasi, mempromosikan recall jangka pendek ke memori jangka panjang. Ini berlaku segera.",
      enableConfirm: "Aktifkan Dreaming",
      disableTitle: "Nonaktifkan Dreaming untuk Semua Agen",
      disableDetail:
        "Sapuan dreaming malam hari akan berhenti untuk setiap agen yang dikonfigurasi, bukan hanya yang ini. Memori yang sudah ditulis tetap ada; tidak ada yang baru dipromosikan. Ini berlaku segera.",
