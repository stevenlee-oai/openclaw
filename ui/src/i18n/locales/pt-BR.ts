...
export const pt_BR: TranslationMap = {
  ...
  dashboardsPage: {
    ...
    emptyDescription: "Abra uma conversa e mude para a face de Dashboard para adicioná-la aqui.",
  ...
  subtitles: {
    ...
    dashboards: "Conversas que abrem na sua face de dashboard.",
    ...
    memory: "Mecanismo de memória, backend, busca e sonho.",
  ...
  memoryPage: {
    ...
    engine: {
      title: "Mecanismo",
      description:
        "Exatamente um plugin de memória ocupa o slot de memória. Selecionar um mecanismo o ativa e desativa os outros.",
      rowTitle: "Mecanismo de memória",
      off: "Desativada",
      autoHint:
        "Nenhum mecanismo está fixado na configuração, então o slot recorre ao seu proprietário padrão.",
      explicitHint: "Este mecanismo está fixado na configuração em plugins.slots.memory.",
      offHint:
        "A memória está desligada na configuração: plugins.slots.memory está definido como none.",
    ...
    addons: {
      title: "Complementos",
      description:
        "Esses plugins funcionam sobre o mecanismo em vez de competir pelo slot, então qualquer combinação pode ser executada ao mesmo tempo.",
      activeMemory: {
        title: "Memória ativa",
      },
      memoryWiki: {
    ...
    import: {
      title: "Importar",
      description: "Traga memória existente de outros assistentes para um workspace de agente.",
      link: "Abrir Importação de Memória",
    },
    search: {
      intro:
        "Padrões de embedding e recuperação compartilhados por todos os agentes que não têm substituição de memória.",
    },
    dreaming: {
      intro:
        "O sonho é executado como um único cron job gerenciado em todos os workspaces de agentes, então essas configurações são globais. Elas pertencem ao plugin {plugin}.",
      schedule: {
        title: "Agendamento",
        description: "Quando a varredura completa é executada e qual modelo a narra.",
      },
      frequency: {
        label: "Frequência do sonho",
        help: "Cadência cron para a varredura completa de sonhos (leve, REM e, então, profundo). Deixe vazio para usar o padrão do plugin.",
        placeholder: "0 3 * * *",
      },
      timezone: {
        label: "Fuso horário",
      ...
      model: {
        label: "Modelo de sonho",
        help: "Substituição de provedor/modelo para narração do diário de sonhos. Requer que substituições de modelo de subagente sejam permitidas.",
        placeholder: "anthropic/claude-sonnet-4-6",
      },
      verboseLogging: {
        label: "Registro detalhado",
        help: "Registra cada fase de sonho em detalhes. Útil ao ajustar limites.",
      },
      storage: {
        title: "Armazenamento",
        description: "Onde memórias promovidas e relatórios de sonho são gravados.",
      ...
      phases: {
        ...
        rem: {
          title: "Fase REM",
          description:
            "Passagem de padrões que busca temas recorrentes ao longo da janela de retrospecto.",
        },
      },
      phaseFields: {
        enabled: "Ativado",
        enabledHelp: "Executar esta fase durante a varredura.",
        lookbackDays: "Dias de retrospecto",
        lookbackDaysHelp: "Até onde esta fase lê no passado. Deixe vazio para o padrão do plugin.",
        limit: "Limite",
        limitHelp: "Máximo de entradas que esta fase processa por execução.",
        dedupeSimilarity: "Similaridade de deduplicação",
        dedupeSimilarityHelp:
          "Similaridade acima da qual dois candidatos são tratados como duplicatas.",
        ...
        maxPromotedSnippetTokens: "Máx. de tokens de trecho promovido",
      ...
      unsupported: {
        ...
        description:
          "O plugin {plugin} controla o slot de memória e seu esquema de configuração não tem seção de sonho, portanto essas configurações não podem ser armazenadas. Troque o mecanismo na aba Visão geral para editá-las.",
      },
    },
  },
  sessionsPage: {
  ...
  labsPage: {
    ...
    localModelLean: {
      ...
      description:
        "Descarte ferramentas padrão pesadas que modelos locais menores lidam mal, deixando um conjunto mais curto que eles conseguem usar de forma confiável.",
    },
    auditMessages: {
      title: "Metadados de auditoria de mensagens",
      description:
        "Registre metadados sem conteúdo para conversas diretas no registro de auditoria. O conteúdo da mensagem nunca é armazenado.",
    },
  },
  aboutPage: {
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      subtitle: "O sonho é uma configuração global; não está restrito a este agente.",
      enableTitle: "Ativar Sonho para Todos os Agentes",
      enableDetail:
        "A varredura noturna de sonho será executada em todos os workspaces de agentes configurados, promovendo memórias de curto prazo para a memória de longo prazo. Isso é aplicado imediatamente.",
      enableConfirm: "Ativar Sonho",
      disableTitle: "Desativar Sonho para Todos os Agentes",
      disableDetail:
        "A varredura noturna de sonho será interrompida para todos os agentes configurados, não apenas este. As memórias já gravadas permanecem; nada novo será promovido. Isso é aplicado imediatamente.",
      disableConfirm: "Desativar Sonho",
      saving: "Salvando…",
