...
export const tr: TranslationMap = {
  ...
  newSession: {
    ...
    draft: "Taslak",
    draftDescription: "Yayınlayana kadar bu konuşmayı kendinize saklayın",
  ...
  agents: {
    ...
    files: {
      ...
      addFile: "Dosya ekle…",
      createHint:
        "Bu dosya henüz mevcut değil. Kaydettiğinizde ajan çalışma alanında oluşturulacak.",
      content: "Content",
      words: "{count} words",
      lines: "lines",
    },
  ...
  memoryPage: {
    ...
    engine: {
      ...
      off: "Kapalı",
      autoHint:
        "Yapılandırmada sabitlenmiş bir motor yok, bu yüzden yuva varsayılan sahibine geri döner.",
      explicitHint: "Bu motor yapılandırmada plugins.slots.memory altında sabitlenmiştir.",
      offHint: "Bellek yapılandırmada kapatılmış: plugins.slots.memory none olarak ayarlanmış.",
      ...
      disabledHint:
        "Bellek yuvası bu eklentiye işaret ediyor, ancak eklentinin kendisi devre dışı olduğundan bellek çalışmıyor.",
      enable: "Etkinleştirin:",
    },
    backend: {
      title: "Arka uç",
    ...
    dreaming: {
      intro:
        "Rüya görme, her aracı çalışma alanında tek bir yönetilen cron işi olarak çalışır, bu nedenle bu ayarlar geneldir. {plugin} eklentisine aittir.",
      schedule: {
        title: "Zamanlama",
        description: "Tam taramanın ne zaman çalıştığı ve hangi modelin anlattığı.",
      },
      frequency: {
        label: "Rüya görme sıklığı",
        help: "Tam rüya görme taraması (hafif, REM, ardından derin) için cron kadansı. Eklenti varsayılanı için boş bırakın.",
        placeholder: "0 3 * * *",
      },
      timezone: {
        label: "Saat dilimi",
        help: "Cron kadansını yorumlamak için kullanılan IANA saat dilimi.",
        placeholder: "Europe/Vienna",
      },
      model: {
        label: "Rüya görme modeli",
        help: "Rüya günlüğü anlatımı için sağlayıcı/model geçersiz kılması. Alt aracı modeli geçersiz kılmalarına izin verilmesini gerektirir.",
        placeholder: "anthropic/claude-sonnet-4-6",
      },
      verboseLogging: {
        label: "Ayrıntılı günlük kaydı",
        help: "Her rüya görme aşamasını ayrıntılı olarak kaydeder. Eşikleri ayarlarken kullanışlıdır.",
      },
      storage: {
        title: "Depolama",
        description: "Yükseltilen anıların ve rüya görme raporlarının nereye yazıldığı.",
        modeLabel: "Depolama modu",
        modeHelp: "Satır içi, bellek dosyasına yazar; ayrı, özel bir rapor dosyası tutar.",
        modes: {
          inline: "Satır içi",
          separate: "Ayrı",
          both: "Her ikisi",
        ...
        separateReportsHelp: "Rüya görme raporlarını ana bellek dosyasının dışında tutar.",
      },
      phases: {
        light: {
          title: "Hafif aşama",
          description: "Yeniden oynatma adaylarını hazırlayan ucuz, son etkinlik taraması.",
        },
        deep: {
          title: "Derin aşama",
          description: "Kısa vadeli girişleri belleğe yükselten puanlı terfi taraması.",
        },
        rem: {
          title: "REM aşaması",
          description: "Geri bakış penceresinde yinelenen temaları arayan desen taraması.",
        },
      },
      phaseFields: {
        enabled: "Etkin",
        enabledHelp: "Bu aşamayı tarama sırasında çalıştır.",
        lookbackDays: "Geri bakış günleri",
        lookbackDaysHelp:
          "Bu aşamanın ne kadar geriye gittiği. Eklenti varsayılanı için boş bırakın.",
        limit: "Sınır",
        limitHelp: "Bu aşamanın her çalıştırmada işlediği en fazla giriş sayısı.",
        dedupeSimilarity: "Yinelenen kaldırma benzerliği",
        dedupeSimilarityHelp: "İki adayın yinelenen olarak kabul edildiği benzerlik üst değeri.",
        minScore: "Minimum puan",
        minScoreHelp: "Bir girişin ulaşması gereken terfi puanı.",
        minRecallCount: "Minimum hatırlama",
        minRecallCountHelp: "Bir girişin terfi edilebilmesi için kaç kez hatırlanması gerektiği.",
        minUniqueQueries: "Minimum benzersiz sorgu",
        minUniqueQueriesHelp: "Girişi kaç farklı sorgunun ortaya çıkarmış olması gerektiği.",
        recencyHalfLifeDays: "Yakınlık yarı ömrü (gün)",
        recencyHalfLifeDaysHelp: "Eski hatırlama sinyallerinin ne kadar hızlı ağırlık kaybettiği.",
        maxAgeDays: "Maksimum yaş (gün)",
        maxAgeDaysHelp: "Bundan daha eski kısa vadeli girdileri yoksay.",
        maxPromotedSnippetTokens: "Maksimum yükseltilen parçacık token'ı",
        maxPromotedSnippetTokensHelp:
          "Yükseltilen her parçacık için token bütçesi. Kaynak bilgisi ekli kalır.",
        minPatternStrength: "Minimum örüntü gücü",
        minPatternStrengthHelp: "Tekrarlanan bir örüntünün raporlanması için ulaşması gereken güç.",
      },
      agentScope: {
      ...
      unsupported: {
        ...
        description:
          "{plugin} eklentisi bellek yuvasına sahiptir ve yapılandırma şemasında rüya görme bölümü bulunmadığından bu ayarlar saklanamaz. Bunları düzenlemek için Genel Bakış sekmesinde motoru değiştirin.",
      },
    },
  },
  sessionsPage: {
  ...
  labsPage: {
    ...
    toolSearch: {
      title: "Araç Arama",
      description:
        "Sınırlı bir araç dizinini görünür tutun ve geri kalanını aramanın arkasına erteleyin, böylece büyük MCP ve eklenti katalogları istemi kalabalıklaştırmayı bıraksın.",
    },
    localModelLean: {
      title: "Yerel modeller için sade araçlar",
      description:
        "Daha küçük yerel modellerin zayıf şekilde işlediği ağır varsayılan araçları kaldırın, güvenilir şekilde kullanabilecekleri daha kısa bir set bırakın.",
    },
    auditMessages: {
      title: "Mesaj denetim meta verisi",
      description:
        "Doğrudan konuşmalar için içerik içermeyen meta verileri denetim kaydında saklayın. Mesaj içeriği asla saklanmaz.",
    },
  },
  aboutPage: {
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      ...
      enableDetail:
        "Gece rüya tarama işlemi, yapılandırılmış her aracı çalışma alanında çalışarak kısa vadeli hatırlatmaları uzun vadeli belleğe aktarır. Bu hemen uygulanır.",
      enableConfirm: "Rüya Görmeyi Aç",
      disableTitle: "Tüm Aracılar İçin Rüya Görmeyi Kapat",
      disableDetail:
        "Gece rüya tarama işlemi yalnızca bu aracı için değil, yapılandırılmış her aracı için durur. Zaten yazılmış anılar kalır; yenisi aktarılmaz. Bu hemen uygulanır.",
  ...
  chat: {
    ...
    sidebarColumns: {
      ...
      detail: "Ayrıntılar",
      close: "{panel} kapat",
      drag: "{panel} öğesini sürükle",
      dropOnEmptyLeft: "{panel} öğesini boş sol kenar çubuğuna taşı",
      dropOnEmptyRight: "{panel} öğesini boş sağ kenar çubuğuna taşı",
      resize: "{panel} öğesini yeniden boyutlandır",
    },
    thread: {
