...
export const uk: TranslationMap = {
  ...
  newSession: {
    ...
    draft: "Чернетка",
    draftDescription: "Тримайте цю розмову лише для себе, доки не опублікуєте її",
  ...
  dashboardsPage: {
    ...
    emptyDescription: "Відкрийте розмову й перемкніться на вигляд Dashboard, щоб додати її сюди.",
  ...
  subtitles: {
    ...
    dashboards: "Розмови, що відкриваються на вигляді дашборда.",
  ...
  memoryPage: {
    ...
    engine: {
      title: "Рушій",
      description:
        "Слот пам'яті займає рівно один плагін пам'яті. Вибір рушія вмикає його й вимикає інші.",
      rowTitle: "Рушій пам'яті",
      off: "Вимкнено",
      autoHint:
        "У конфігурації не закріплено жодного рушія, тож слот повертається до власника за замовчуванням.",
    ...
    addons: {
      title: "Додатки",
      description:
        "Ці плагіни працюють поверх рушія, а не конкурують за слот, тому будь-яка комбінація може виконуватися одночасно.",
      activeMemory: {
    ...
    search: {
      intro:
        "Стандартні налаштування вбудовування та отримання, спільні для кожного агента, який не має перевизначення пам'яті.",
    },
    dreaming: {
      intro:
        "Сновидіння виконується як одне кероване cron-завдання для кожного робочого простору агента, тому ці налаштування глобальні. Ними володіє плагін {plugin}.",
      schedule: {
        title: "Розклад",
        description: "Коли виконується повний прохід і яка модель його озвучує.",
      },
      frequency: {
        label: "Частота сновидінь",
        help: "Cron-розклад для повного циклу сновидінь (легка фаза, REM, потім глибока). Залиште порожнім для типового значення плагіна.",
        placeholder: "0 3 * * *",
      },
      timezone: {
        label: "Часовий пояс",
        help: "Часовий пояс IANA, який використовується для інтерпретації cron-розкладу.",
        placeholder: "Europe/Vienna",
      },
      model: {
        label: "Модель сновидінь",
        help: "Перевизначення постачальника/моделі для оповіді щоденника сновидінь. Потребує дозволу на перевизначення моделей субагентів.",
        placeholder: "anthropic/claude-sonnet-4-6",
      },
      verboseLogging: {
        label: "Докладне журналювання",
        help: "Докладно журналювати кожну фазу сновидінь. Корисно під час налаштування порогів.",
      },
      storage: {
        title: "Сховище",
        description: "Де записуються підвищені спогади та звіти про сновидіння.",
        ...
        separateReportsHelp: "Тримати звіти про сновидіння поза основним файлом пам'яті.",
      },
      phases: {
        light: {
          title: "Легка фаза",
        ...
        deep: {
          title: "Глибока фаза",
          description: "Оцінений прохід підвищення, що переводить короткочасні записи в пам'ять.",
        },
        rem: {
          title: "Фаза REM",
          description: "Прохід за шаблонами, що шукає повторювані теми у вікні ретроспективи.",
        },
      },
      phaseFields: {
        enabled: "Увімкнено",
        enabledHelp: "Запускати цю фазу під час проходу.",
        lookbackDays: "Днів ретроспективи",
        lookbackDaysHelp:
          "Наскільки далеко назад читає ця фаза. Залиште порожнім для значення плагіна за замовчуванням.",
        limit: "Ліміт",
        limitHelp: "Максимальна кількість записів, які обробляє ця фаза за запуск.",
        ...
        minRecallCount: "Мінімум відкликань",
        minRecallCountHelp: "Як часто запис має бути відкликаний, перш ніж його можна підвищити.",
        minUniqueQueries: "Мінімум унікальних запитів",
        minUniqueQueriesHelp: "Скільки різних запитів мали виявити запис.",
        recencyHalfLifeDays: "Період напіврозпаду свіжості (дні)",
        recencyHalfLifeDaysHelp: "Як швидко старіші сигнали відкликання втрачають вагу.",
        maxAgeDays: "Максимальний вік (днів)",
        maxAgeDaysHelp: "Ігнорувати короткострокові записи, старші за це значення.",
        maxPromotedSnippetTokens: "Макс. токенів у підвищеному фрагменті",
        maxPromotedSnippetTokensHelp:
          "Бюджет токенів для кожного підвищеного фрагмента. Джерело залишається прикріпленим.",
        minPatternStrength: "Мінімальна сила патерну",
        minPatternStrengthHelp:
          "Сила, якої має досягти повторюваний патерн, щоб про нього повідомили.",
      },
      agentScope: {
        title: "Перегляд агента",
        description:
          "Наведені вище налаштування є глобальними. Щоденник снів, короткострокові лічильники та дії з обслуговування нижче належать одному агенту.",
        rowTitle: "Агент",
      },
      unsupported: {
        title: "Налаштування снів",
        rowTitle: "Недоступно для цього рушія",
        description:
          "Плагін {plugin} володіє слотом пам'яті, а його схема конфігурації не має розділу снів, тож ці налаштування не можна зберегти. Змініть рушій на вкладці Огляд, щоб їх редагувати.",
      },
    },
  },
  sessionsPage: {
  ...
  labsPage: {
    ...
    toolSearch: {
      ...
      description:
        "Тримайте обмежений каталог інструментів видимим, а решту відкладайте за пошуком, щоб великі каталоги MCP і плагінів не перевантажували підказку.",
    },
    localModelLean: {
      title: "Спрощені інструменти для локальних моделей",
      description:
        "Прибрати важкі стандартні інструменти, з якими погано справляються менші локальні моделі, залишивши коротший набір, який вони можуть надійно використовувати.",
    },
    auditMessages: {
      title: "Метадані аудиту повідомлень",
      description:
        "Записувати метадані без вмісту для прямих розмов у журнал аудиту. Вміст повідомлень ніколи не зберігається.",
    },
  },
  aboutPage: {
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      subtitle: "Сни — це глобальне налаштування; воно не обмежене цим агентом.",
      enableTitle: "Увімкнути сновидіння для всіх агентів",
      enableDetail:
        "Нічний прохід сновидінь виконуватиметься для кожного налаштованого робочого простору агента, переносячи короткострокові спогади в довгострокову пам'ять. Застосовується негайно.",
      enableConfirm: "Увімкнути сновидіння",
      disableTitle: "Вимкнути сновидіння для всіх агентів",
      disableDetail:
        "Нічний прохід сновидінь зупиниться для кожного налаштованого агента, а не лише для цього. Уже записані спогади залишаться; нічого нового не переноситься. Застосовується негайно.",
  ...
  chat: {
    ...
    sessionRoute: {
      ...
      additionalMatches:
        "Залишаються результати пошуку. Використайте довший префікс ідентифікатора.",
    },
    sessionSharing: {
